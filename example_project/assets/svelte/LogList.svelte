        ...
        <div class="card-body gap-4 p-5">
            ...
            <div class="flex flex-wrap items-center gap-4">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" class="checkbox checkbox-sm checkbox-brand" bind:checked={showItems} />
                ...
                <label class="flex items-center gap-2">
                    ...
                    <input type="range" class="range range-brand range-sm w-32" bind:value={i} max={items.length || 1} min="1" />
            ...
            <form class="flex gap-2 flex-wrap">
                ...
                />
                <button type="submit" class="btn btn-sm bg-brand text-white border-0 hover:opacity-90" onclick={preventDefault(addItem)}>
                    Add item
                </button>
            </form>
