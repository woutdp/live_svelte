...
<div class="w-full flex flex-col items-center">
    <div class="card bg-base-100 shadow-md border border-base-300/50 overflow-hidden w-full max-w-md flex flex-col sm:w-[360px] sm:max-w-none">
        <div class="card-body gap-0 p-0 flex flex-col min-h-0 flex-1 sm:h-[520px]">
            ...
            <ul
                ...
                class="flex flex-col gap-3 flex-1 min-h-0 overflow-x-clip overflow-y-auto px-4 py-2"
            >
            ...
            <form
                onsubmit={preventDefault(submitMessage)}
                class="p-4 border-t border-base-300/50 bg-base-200/30 flex gap-2 items-center"
            >
