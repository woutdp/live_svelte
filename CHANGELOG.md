...
- `LiveSvelte.SSR.Deno` — a new SSR adapter for applications using [`deno_rider`](https://github.com/aglundahl/deno_rider) as a production alternative to `LiveSvelte.SSR.NodeJS`.
